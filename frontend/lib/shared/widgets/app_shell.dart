      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        onTap: (index) {
          if (isGuest && index != 0) {
            ...
            String msg = 'Please create an account or sign in to access this feature.';
            String route = '/home';

            if (index == 1) {
              title = 'Sign In to Offer Rides';
              msg = 'Sharing your vehicle seats and publishing routes requires driver identity verification.';
              route = '/offer-ride';
            } else if (index == 2) {
              title = 'Sign In to View Bookings';
              msg = 'Sign in or register to manage your confirmed and pending shared ride bookings.';
              route = '/my-bookings';
            } else if (index == 3) {
              title = 'Sign In to View Profile';
              msg = 'Manage your account settings, emergency contacts, and vehicle registration.';
              route = '/profile';
            }
